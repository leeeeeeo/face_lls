...
def nod3DModel(objLines, nodCenter):
    nodedObjLines = []
...
def nod(objFilePath, nodAngle, nodCenterMode):
    '''read origin obj file'''
    objLines, vLines, fLines = readObj(objFilePath)
    # objLines = objFloat2Int(objLines)
    '''1. find nod center'''
    ...
    '''2. nod every point in YZ plane around maxYCoord'''
    nodedObjLines = nod3DModel(objLines, nodCenter)
