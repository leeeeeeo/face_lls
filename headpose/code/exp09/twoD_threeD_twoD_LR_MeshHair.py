...
def main2D_3D_2D_LR_MeshHair():
    ...
    edgePoints = addOuterEllipseEdgeLandmark(ellipseParam, img)
    drawPointsOnImg(ellipseVerts, img, 'g')
    ...
    return hairMeshPointsInEllipseList, nodHairLandmark2DList, edgePoints
