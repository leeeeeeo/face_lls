...
def recoverMask(ptsTargetPath, imgOriginal):
...
def morph(ptsOriginalPath, ptsTargetPath, imgOriginal, triTxtPath):
    ptsOriginal = readPoints(ptsOriginalPath)
    ptsTarget = readPoints(ptsTargetPath)
...
"""
imgMorph = morph(ptsOriginalPath, ptsTargetPath, imgOriginal, triTxtPath)
"""
makeup face area mask
"""
imgRecover = recoverMask(ptsTargetPath, imgOriginal)
"""
