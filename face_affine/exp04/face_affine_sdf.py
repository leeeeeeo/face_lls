...
def saveTriangleTxt(triangleTxtPath, imgOriginal, ptsOriginalPath):
    ...
    for i, pts in enumerate(readPoints(ptsOriginalPath)):
        ptsDict['({}, {})'.format(int(pts[0]), int(pts[1]))] = i
...
def mainAffine():
    imgOriginalPath = '/Users/lls/Desktop/hillary/video_for_blink_1.png'
    ptsOriginalPath = '/Users/lls/Desktop/hillary/coord_1.txt'
    # ptsTargetPath = './data/source/S132_16.png.txt'
    myTriTxtPath = '/Users/lls/Desktop/hillary/sdftri.txt'
